...
const Footer = () => {
        ...
        <SocialMedia>
          <SocialMediaWrap>
            <FooterLinkItems className="socials">
              ...
              <a
                href="https://github.com/MonalikaPatnaik/UMatter"
                target="_blank"
  ...
  `}</style>
            ...
            <FooterLinkItems className="socials">{/* Social media icons */}</FooterLinkItems>
            <SocialLogo onClick={handleClick}>UMatter</SocialLogo>
            <WebsiteRights>
              UMatter © {new Date().getFullYear()}&nbsp;All rights reserved.
            </WebsiteRights>
          </SocialMediaWrap>
        </SocialMedia>
      </FooterWrap>
