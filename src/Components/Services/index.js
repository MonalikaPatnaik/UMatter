...
import Icon4 from '../../images/image4.png';
import { Services_Data } from '../Services/Services_Data';
import { ServicesContainer, ServicesH1, ServicesH2, ServicesWrapper, ServicesCard, ServicesIcon, ServicesP,CarouselContainer } from './ServicesElements';
...
const Services = () => {
  ...
  return (
    ...
    <Carousel
          ...
          infiniteLoop={true}
          autoPlay={true}
          interval={5000} // adjust the interval duration as needed
          stopOnHover={true}
          swipeable={true}
          emulateTouch={true}
        >
