...
const onSubmit = () => {
  ...
  return (
    <>
      ...
      <div className='flex mx-auto mt-[0.8rem] flex-row space-x-4 py-0 w-[55%]'><button type="button" id="succesBTN" onClick={onSubmit} className="block w-[9rem] text-base mx-auto py-1 bg-[#01bf71] text-white rounded-full hover:bg-[#00492B] font-regular" >Verify Captcha</button></div>
    </>
  )
}
